"""
Django settings for red_flower_39511 project.
...
ROOT_URLCONF = 'red_flower_39511.urls'
...
WSGI_APPLICATION = 'red_flower_39511.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_flower_39511 API",
    "DESCRIPTION": "API documentation for red_flower_39511 App",
    "VERSION": "v1",
}
